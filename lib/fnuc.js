...
(function() {
  var ARITY, CHAINABLE, I, _, _fold, _foldr, _toString, aand, add, all, any, arity, arityof, binary, builtin, chainable, clone, compose, concat, contains, curry, div, drop, each, eq, eql, evolve, exports, expose, filter, flip, fold, fold1, foldr, foldr1, get, groupby, gt, gte, has, head, ident, index, indexfn, isplain, join, keys, last, lcase, len, lt, lte, map, match, max, merge, min, minifyNot, mixin, mod, mul, ncurry, nnot, ofilter, omap, oor, partial, partialr, pick, replace, reverse, search, sequence, set, shallow, slice, sort, split, sub, tail, take, tap, ternary, trim, type, typeis, ucase, unary, uncurry, uniq, uniqfn, values, zip, zipwith,
    slice1 = [].slice;
