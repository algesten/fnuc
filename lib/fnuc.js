...
(function() {
  var I, _defprop, _filter, _fold, _foldr, _ispfail, _pliftall, _toString, aand, add, all, always, any, apply, arity, arityof, asprop, binary, builtin, clone, compose, concat, contains, converge, curry, curry2, curry2var, curry3, curry3var, div, drop, each, eq, eql, evolve, exports, expose, filter, firstfn, flip, fold, fold1, foldr, foldr1, get, gt, gte, has, head, iif, index, indexfn, isdef, isplain, join, keys, keyval, last, lastfn, lcase, len, lt, lte, map, match, max, maybe, merge, min, mixin, mod, mul, ncurry, nnot, nth, ofilter, once, oor, partial, partialr, pfail, pick, pipe, plift, replace, reverse, search, set, shallow, slice, sort, split, sub, tail, take, tap, ternary, trim, type, typeis, ucase, unary, uncurry, uniq, uniqfn, values, zip, zipobj, zipwith,
    slice1 = [].slice;
