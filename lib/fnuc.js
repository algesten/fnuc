...
(function() {
  var ARITY, CHAINABLE, I, add, all, and_, any, arity, binary, builtin, chainable, clone, compose, concat, contains, curry, div, drop, each, eq, eql, evolve, exports, expose, filter, flip, fold, fold1, foldr, foldr1, get, groupby, gt, gte, has, head, ident, index, isplain, join, keys, last, lcase, lt, lte, map, match, max, merge, min, minifyNot, mixin, mod, mul, ncurry, not_, ofilter, omap, or_, partial, partialr, pick, replace, reverse, search, sequence, set, shallow, slice, sort, split, sub, tail, take, tap, ternary, trim, type, typeis, ucase, unary, uncurry, uniq, values, _, _fold, _foldr, _toString,
    __slice = [].slice;
