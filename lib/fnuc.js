...
(function() {
  var ARITY, CHAINABLE, I, Tuple, add, all, and_, any, arity, binary, builtin, chainable, clone, compose, concat, contains, curry, div, drop, each, eq, eql, evolve, exports, expose, filter, flip, fold, fold1, foldr, foldr1, fst, get, groupby, gt, gte, has, head, ident, index, isplain, join, keys, last, lcase, len, lt, lte, map, match, max, merge, min, minifyNot, mixin, mod, mul, ncurry, not_, nth, ofilter, omap, or_, partial, partialr, pick, replace, reverse, search, sequence, set, shallow, slice, snd, sort, split, sub, tail, take, tap, ternary, trim, tuple, type, typeis, ucase, unary, uncurry, uniq, unpack, unzip, values, zip, zipwith, _, _fold, _foldr, _toString,
    __slice = [].slice;
  ...
  eql = (function() {
    ...
    return curry(function(a, b) {
      ...
      return (and_(eqtype, (function() {
        switch (type(a)) {
          case 'tuple':
            return eqtuple;
          case 'object':
            return and_(eqplain, eqobj);
          case 'array':
            return eqarr;
          default:
            return function() {
  ...
  expose = function(exp, guard) {
    return function() {
      var def, funs, k, obj, v, val, _i, _len;
      ...
      def = function(k, v) {
        return Object.defineProperty(obj, k, val(v));
      };
