...
(function() {
  var I, _defprop, _filter, _fold, _foldr, _ispfail, _nary, _pliftall, _toString, _uncurry, aand, add, all, always, any, apply, arity, arityof, asprop, at, binary, both, builtin, clone, comp, compose, concat, cond, contains, converge, curry, curry2, curry2var, curry3, curry3var, div, drop, each, either, eq, eql, evolve, exports, expose, filter, firstfn, flip, fold, fold1, foldr, foldr1, get, gt, gte, has, head, iif, index, indexfn, isdef, isplain, join, keys, keyval, last, lastfn, lcase, len, lt, lte, map, match, max, maybe, merge, min, mixin, mod, mul, ncurry, nnot, nth, ofilter, omap, once, oor, pall, partial, partialr, pfail, pick, pipe, plift, replace, reverse, search, set, shallow, slice, sort, split, sub, tail, take, tap, ternary, trim, type, typeis, ucase, unapply, unary, uniq, uniqfn, values, zip, zipobj, zipwith,
    slice1 = [].slice;
