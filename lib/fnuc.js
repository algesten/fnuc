...
(function() {
  var ARITY, CHAINABLE, I, _, _filter, _firstthenable, _fold, _foldr, _isthenable, _promapply, _toString, aand, add, all, any, apply, arity, arityof, binary, builtin, chainable, clone, compose, concat, contains, converge, curry, div, drop, each, eq, eql, evolve, exports, expose, filter, firstfn, flip, fold, fold1, foldr, foldr1, get, groupby, gt, gte, has, head, ident, index, indexfn, isplain, join, keys, last, lastfn, lcase, len, lt, lte, map, match, max, merge, min, minifyNot, mixin, mod, mul, ncurry, nnot, ofilter, omap, oor, partial, partialr, pick, pipe, plift, ppipe, replace, reverse, search, set, shallow, slice, sort, split, sub, tail, take, tap, ternary, trim, type, typeis, ucase, unary, uncurry, uniq, uniqfn, values, zip, zipwith,
    slice1 = [].slice;
  ...
  _firstthenable = pipe(firstfn(_isthenable), function(p) {
