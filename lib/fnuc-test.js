...
(function() {
  ...
  describe('mixin', function() {
    return describe('returns a new object with all arguments merged and', function() {
      it('handles one object with curry', function() {
        var f, r;
        f = mixin({
          a: 1
        });
  ...
  describe('partial', function() {
    return describe('partially fills in arguments from the left', function() {
      it('function for arity(0)', function() {
        var f;
        f = partial((function() {
          return 42;
        }));
      ...
      it('function for arity(0) with arguments', function() {
        var f, s;
        f = partial((s = spy(function() {
          return 42;
        })), 1, 2, 3);
        eql(f(4, 5), 42);
        return eql(s.args[0], [1, 2, 3, 4, 5]);
      });
      ...
      it('function for arity(1) with arguments', function() {
        var fn;
      ...
      it('function for arity(2) with arguments', function() {
        var fn;
      ...
      return describe('for arity(3)', function() {
        ...
        return it('function with arguments', function() {
          var f, s;
          f = partial((s = spy(function(a, b, c) {
            return a / (b / c);
          })), 12, 3, 2, 5);
          eql(f(4, 5), 8);
          return eql(s.args[0], [12, 3, 2, 5, 4, 5]);
        });
      });
    });
  });
  ...
  describe('partialr', function() {
    return describe('partially fills in arguments from the right', function() {
      ...
      it('function for arity(0) with arguments', function() {
        var f, s;
        f = partialr((s = spy(function() {
          return 42;
        })), 1, 2, 3);
        eql(f(4, 5), 42);
        return eql(s.args[0], [1, 2, 3]);
      });
      it('handles arity(1)', function() {
        var r;
      ...
      it('function for arity(2) with arguments', function() {
        var f, s;
        f = partialr((s = spy(function(a, b) {
          return a / b;
        })), 42, 2);
        eql(f(10, 5), 21);
        return eql(s.args[0], [42, 2]);
      });
      return describe('for arity(3)', function() {
        it('works with one arg', function() {
          var r;
  ...
  describe('pipe', function() {
    describe('(f1,f2)', function() {
      ...
      it('maintains arity for f1', function() {
        eql(arityof(calc), 2);
        eql(arityof(pipe((function() {}), I)), 0);
        eql(arityof(pipe((function(a) {}), I)), 1);
        eql(arityof(pipe((function(a, b) {}), I)), 2);
        return eql(arityof(pipe((function(a, b, c) {}), I)), 3);
      });
      ...
      it('pipes vararg funs', function(done) {
        var fn;
        fn = pipe(function() {
          var as;
          as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
      ...
      it('is curried', function() {
        return eql(calc(4)(6), 1);
      });
      return it('can pipe curried functions', function() {
        var dopick, fn;
        fn = pipe(split(' '), pick);
        dopick = fn('abc');
        return eql(dopick({
  ...
  describe('converge', function() {
    ...
    it('converges vararg funs', function(done) {
      var a, b, fn;
      a = function() {
        var as;
        as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
    ...
    it('deals with arity 0', function(done) {
      var a, b, fn;
      a = function(a) {
        return 1;
      };
      ...
      fn = converge(a, b, function() {
        return done();
      });
      return fn(1);
    });
    return it('isnt crazy with pipe', function() {
      var norun;
      norun = function() {
        throw new Error("Nooo!");
      };
      converge(norun, pipe(norun), norun);
      return converge(norun, pipe(norun, I), norun);
    });
  });
  ...
  describe('call', function() {
    it('calls first argument with consequent', function() {
      return eql(call(add, 1, 2), 3);
    });
    it('is curried', function() {
      return eql(call(1)(I), 1);
    });
    return it('can be partialed', function() {
      return eql(partial(call, add)(1, 2), 3);
    });
  });
