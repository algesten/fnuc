...
(function() {
  var F, FN_TEST, Foo, Q, TYPES, TYPE_ARR, TYPE_NO_PROTO, TYPE_PLAIN, TYPE_PROTO, assert, chai, date, eql, foldfn, later, mock, sandbox, sinon, spy, stub,
    slice1 = [].slice;
  ...
  describe('pipe', function() {
    describe('(f1,f2)', function() {
      ...
      return it('can take promises as result of pipe steps', function() {
        var addl, calcl;
        addl = function(a, b) {
    ...
    return describe('(f1,f2,pfail,f3)', function() {
      ...
      it('invokes pfail if invoked with rejected promise', function() {
        return f(Q.reject('reject'), 3).then(function(r) {
  ...
  describe('converge', function() {
    ...
    return it('can pfail as after fn', function() {
      var fn;
      fn = converge(mul2, mul3, pfail(function(err) {
        return "did " + err;
      }));
      return fn(Q.reject('reject')).then(function(r) {
  ...
  describe('iif', function() {
    ...
    it('returns a function which arity is that of c', function() {
      var c, f, t;
      c = function(a, b) {};
      t = function(a) {};
      f = function(a, b, c, d) {};
      return eql(arityof(iif(c, t, f)), 2);
    });
    it('is curried', function() {
      var fn1, fn2;
      fn1 = spy(function() {
  ...
  describe('nth', function() {
    ...
    it('it produces an arity that of the arg + 1', function() {
      arityof(nth(1), 2);
      return arityof(nth(4), 5);
    });
    return it('is ok with n outside', function() {
      eql(nth(5)(1, 2, 3), void 0);
      return eql(nth(-1)(1, 2, 3), void 0);
    });
  });
  ...
  describe('pfail', function() {
    ...
    describe('with multiple rejected promise argument', function() {
      return it('is invoked', function() {
        return fn(Q.reject('reject 1'), Q.reject('reject 2')).then(function(r) {
          eql(s.args.length, 1);
