...
(function() {
  var F, FN_TEST, Foo, Q, TYPES, TYPE_ARR, TYPE_NO_PROTO, TYPE_PLAIN, TYPE_PROTO, assert, chai, date, eql, foldfn, mock, sandbox, sinon, spy, stub,
    slice1 = [].slice;
  ...
  describe('ppipe', function() {
    ...
    it('does immediate application', function() {
      var add, calc, div10;
      add = function(a, b) {
        return a + b;
      };
    ...
    return it('can take promises as result of pipe steps', function() {
      ...
      div10 = div(10);
      calc = ppipe(add, div10);
      return calc(10, 20).then(function(v) {
        return eql(v, 3);
      });
    });
  });
  ...
  describe('converge', function() {
    ...
    return it('curries the resulting function', function() {
      var fn;
      fn = converge(add, (function(a, b) {
        return a + b;
      }), (function(a, b, c) {
        return a + b + c;
      }));
  ...
  describe('iif', function() {
    ...
    return it('works for variadic', function() {
      var fn, fn1, fn2, tst;
      tst = spy(I);
      fn1 = spy(function() {
        return 42;
  ...
  describe('maybe', function() {
    ...
    return it('works for variadic input', function() {
      var fn;
      fn = maybe(function() {
        return 42;
      });
